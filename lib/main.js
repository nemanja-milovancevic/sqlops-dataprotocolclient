...
exports.SqlOpsDataClient = exports.FileBrowserFeature = exports.TaskServicesFeature = exports.ScriptingFeature = exports.ObjectExplorerFeature = exports.BlobFeature = exports.RestoreFeature = exports.BackupFeature = exports.AdminServicesFeature = exports.MetadataFeature = exports.QueryFeature = exports.ConnectionFeature = exports.CapabilitiesFeature = exports.SqlOpsFeature = void 0;
...
class BlobFeature extends SqlOpsFeature {
    constructor(client) {
    ...
    registerProvider(options) {
        const client = this._client;
        let createSas = (ownerUri, blobContainerUri, blobContainerKey, storageAccountName, expirationDate) => {
            let params = { ownerUri, blobContainerUri, blobContainerKey, storageAccountName, expirationDate };
            return client.sendRequest(protocol.CreateSasRequest.type, params).then(r => r, e => {
...
exports.BlobFeature = BlobFeature;
BlobFeature.messagesTypes = [
    protocol.CreateSasRequest.type
];
