...
class BackupFeature extends SqlOpsFeature {
    ...
    registerProvider(options) {
        ...
        let createSas = (blobContainerUri) => {
            let params = { blobContainerUri };
            return client.sendRequest(protocol.CreateSasRequest.type, params).then(r => r.sharedAccessSignature, e => {
