...
exports.SqlOpsDataClient = exports.FileBrowserFeature = exports.TaskServicesFeature = exports.ScriptingFeature = exports.ObjectExplorerFeature = exports.RestoreFeature = exports.BlobFeature = exports.BackupFeature = exports.AdminServicesFeature = exports.MetadataFeature = exports.QueryFeature = exports.ConnectionFeature = exports.CapabilitiesFeature = exports.SqlOpsFeature = void 0;
...
class BlobFeature extends SqlOpsFeature {
    ...
    registerProvider(options) {
        const client = this._client;
        let createSas = (ownerUri, blobContainerUri, blobContainerKey, storageAccountName) => {
            let params = { ownerUri, blobContainerUri, blobContainerKey, storageAccountName };
