...
var ConnectionUriChangedNotification;
(function (ConnectionUriChangedNotification) {
    ConnectionUriChangedNotification.type = new vscode_languageclient_1.NotificationType('query/connectionUriChanged');
})(ConnectionUriChangedNotification = exports.ConnectionUriChangedNotification || (exports.ConnectionUriChangedNotification = {}));
/**
 * Parameters to provide when changing the uri associated with a query.
 */
class ConnectionUriChangedParams {
}
exports.ConnectionUriChangedParams = ConnectionUriChangedParams;
...
var CreateSasRequest;
(function (CreateSasRequest) {
    CreateSasRequest.type = new vscode_languageclient_1.RequestType('backup/createsas');
})(CreateSasRequest = exports.CreateSasRequest || (exports.CreateSasRequest = {}));
var RestoreRequest;
